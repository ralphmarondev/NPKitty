// =================================================================================
// ==      FINAL CODE: NPK SENSOR (TINANGGAL ANG "ONLINE MODE" TEXT)              ==
// =================================================================================
...
const char* serverName = "http://192.168.0.127/npkitty/web/receive.php";
...
void drawHomeScreen() {
  ...
  // --- ITO ANG LUGAR KUNG SAAN TINANGGAL ANG "ONLINE MODE" TEXT ---
  // tft.setTextSize(3);
